...
/**
 * 
 * CÓDIGO MODIFICADO PARA O CONTADOR DE SOFTWARES NÃO LEVAR EM CONTA A ENTIDADE
 * NA HORA DE CONTAR O TOTAL DE SOFTWARES INSTALADOS NA MÁQUINA
 * 
 * ---------------------------------------------------------------------
...
class Item_SoftwareVersion extends CommonDBRelation {
   ...
   **/
   ...
   protected static function getListForItemParams(CommonDBTM $item, $noent = true) { // CÓDIGO MODIFICADO PARA RETORNAR NUMERAÇÃO CORRETA NA ABA 'SOFTWARES'

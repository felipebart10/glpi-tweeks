 ...
 * ---------------------------------------------------------------------
 * 
 * CÓDIGO EDITADO PARA PERSONALIZAÇÃO.
 * PESQUISE POR "CÓDIGO MODIFICADO" PARA ENCONTRAR AS EDIÇÕES PERSONALIZADAS
 * 
 * ---------------------------------------------------------------------
   ...
   function showStatsTimes() {
      ...
      if (in_array($this->fields['status'], array_merge($this->getSolvedStatusArray(),
         ...
         if ($this->fields['solve_delay_stat'] > 0) {
            // CÓDIGO MODIFICADO: ADICIONADO O PARÂMETRO use_days:false PARA NÃO MOSTAR OS DIAS.
            echo Html::timestampToString($this->fields['solve_delay_stat'], 1, 0);
         } else {
            echo '&nbsp;';
         }
         echo "</td></tr>";
      ...
      if (in_array($this->fields['status'], $this->getClosedStatusArray())) {
         ...
         if ($this->fields['close_delay_stat'] > 0) {
            // CÓDIGO MODIFICADO: ADICIONADO O PARÂMETRO use_days:false PARA NÃO MOSTAR OS DIAS.
            echo Html::timestampToString($this->fields['close_delay_stat'], 1, 0);
         } else {
            echo '&nbsp;';
         }
         echo "</td></tr>";
      ...
      if ($this->fields['waiting_duration'] > 0) {
         // CÓDIGO MODIFICADO: ADICIONADO O PARÂMETRO use_days:false PARA NÃO MOSTAR OS DIAS.
         echo Html::timestampToString($this->fields['waiting_duration'], 1, 0);
      } else {
         echo '&nbsp;';
      }
      echo "</td></tr>";

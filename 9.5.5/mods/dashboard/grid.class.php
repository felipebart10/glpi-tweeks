 ...
 * 
 * CÓDIGO EDITADO
 * PROCURE POR "CÓDIGO MODIFICADO" PARA ENCONTRAR AS EDIÇÕES.
 * 
 * ---------------------------------------------------------------------
...
HTML;
   ...
   public function getAllDasboardCards(): array {
      ...
      // CÓDIGO MODIFICADO: ADIÇÃO DO ITENS PERSONALIZADOS NA ARRAY DOS TIPOS DE RELATÓRIOS
      // QUE PODEM SER CRIADOS ATRAVÉS DOS CARTÕES NO DASHBOARD.
      $tickets_cases = [
